...
const BasicVisualizers = {
    // Bar visualization 
    drawBars(ctx, frequencyData, canvas, sensitivity, colorTheme, customColor) {
        ...
        const gradient = VisualizerCore.createGradient(ctx, width, height, colorTheme, customColor);
    ...
    drawCircular(ctx, frequencyData, canvas, sensitivity, colorTheme, customColor) {
        const width = canvas.width;
        const height = canvas.height;
    ...
    // Wave visualization
    drawWave(ctx, frequencyData, canvas, sensitivity, colorTheme, customColor) {
        const width = canvas.width;
        const height = canvas.height;
    ...
    drawParticles(ctx, frequencyData, canvas, sensitivity, colorTheme, customColor, particles = []) {
        const width = canvas.width;
        const height = canvas.height;

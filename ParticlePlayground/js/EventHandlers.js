...
export function setupControlsEventHandlers(system) {
  ...
  const connectionsToggle = document.getElementById('show-connections-toggle');
  ...
  connectionsToggle.addEventListener('change', (e) => {
    system.showConnections = e.target.checked;
    document.getElementById('show-connections-value').textContent = system.showConnections ? 'On' : 'Off';
  });
